	...
	foreach($orte as $ort) {
		...
		<tr>
			...
			<td>
				...
				<a href="<?php echo site_url('geraete/geraete/'.$ort['oid']); ?>" class="btn btn-success"><span class="iconify icon:fa-solid:car-side icon-width:20 icon-height:20"></span> Übersicht</a>
